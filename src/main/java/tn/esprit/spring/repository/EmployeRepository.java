...
//			+ "DISTINCT emp from Employe emp "
//			+ "join emp.departements dps "
//			+ "where deps.entreprise.id:=id")
//    @Query("Select DISTINCT emp.id from Employe emp join departement dps where dps.entreprise_id=emp.id")
    
    @Query("SELECT nom FROM Employe")
    // à tester avec l'id :  deps.entreprise=:entreprise 
